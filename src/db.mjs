...
export function getDb(dbPath) {
  ...
  // Migration 010: intel pipeline (runs, jobs, raw_items, clusters, summaries, llm_calls, source_fetch_state, source_categories)
  try {
    const sql10 = readFileSync(join(ROOT, 'migrations', '010_intel_pipeline.sql'), 'utf8');
    _db.exec(sql10);
  } catch (e) {
